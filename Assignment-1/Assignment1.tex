...
\begin{lstlisting}
https://github.com/KoteshSatvik/AI1103-Probability_and_Random_Variables/tree/main/Assignment-1/Assignment1.py
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/KoteshSatvik/AI1103-Probability_and_Random_Variables/tree/main/Assignment-1/Assignment1.tex
\end{lstlisting}
\section{Problem 4.9}
...
P(X) = probability of obtaining X as the sum and let us represent the case when first dice shows the number $x_1$ and the second dice shows the number $x_2$ as $(x_1,x_2)$.\\
\vspace{2mm}
Then,\\
P(X=2) = 1/36 : [(1,1)]\\\
P(X=3) = 2/36 : [(1,2),(2,1)]\\
...
P(X)                    &$\frac{1}{36}$   &$\frac{2}{36}$   &$\frac{3}{36}$   &$\frac{4}{36}$   &$\frac{5}{36}$   &$\frac{6}{36}$   &$\frac{5}{36}$   &$\frac{4}{36}$   &$\frac{3}{36}$    &$\frac{2}{36}$    &$\frac{1}{36}$    \\ \hline
\end{tabular}
\end{table}
\begin{align*}
    Mean & =\sum XP(X)\\
    & = \displaystyle\frac{1}{36}[(2\times1)+(3\times2)+(4\times3)+(5\times4)+(6\times5)\\
    &+(7\times6)+(8\times5)+(9\times4)+(10\times3)+(11\times2)\\
    &+(12\times1)]\\
    & = \frac{252}{36}=7
\end{align*}
\begin{align*}
    Variance &= \sum X^2P(X) - {\overline{X}}^2\\
...
\end{align*}
Therefore,\\
Standard Deviation = $\displaystyle\sqrt{\frac{35}{6}}$
