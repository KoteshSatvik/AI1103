...
N : Event of obtaining N as the output.\\
Y : Event of obtaining Y as the output.\\
T : Event of obtaining (TAIL, TAIL) as the output.\\
Let us define the state of a Markov chain at time t is the value of $X_t$.\\
Then,\\
$\pr{X_1=N|X_0=S}$ = 2/4 : [(H,T), (H,H)]\\
$\pr{X_1=Y|X_0=S}$ = 1/4 : [(T,H)]\\
$\pr{X_1=T|X_0=S}$ = 1/4 : [(T,T)]
...
\end{align}
$\therefore$ \boxed{\pr{\text{absorption in Y$|X_0$ = S}} = \frac{1}{3}}\\
